...
Da das Storybook für jede App ein Light- und Dark-Theme enthält und es hierfür einen besonderen `ThemeProvider` gibt, werden für Storybook besondere Klassen benötigt, die genauso auf `@northware/ui` anwendbar sind.
